...
<?= $this->section('content'); ?>
    ...
    <div class="right_col" role="main">
        ...
        <div class="col-md-12 ">
	        <div class="x_panel">
				<div class="x_title">
					<h2>Form Tambah Data Orang Tua Anak</h2>
				...
				<div class="x_content">
					<br />
					<form class="form-horizontal form-label-left" action="/ortu/save" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                ...
                                'is-invalid' : ''; ?>" data-inputmask="'mask' : '9999999999999999'" name="ibunik" placeholder="NIK Ibu" value="<?= old('ibunik'); ?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group row ">
                            <label class="control-label col-md-3 col-sm-3 ">Tempat dan Tanggal Ibu</label>
                            <div class="col-md-5 col-sm-5">
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                ...
                                'is-invalid' : ''; ?>" name="ibupekerjaan" placeholder="Pekerjaan Ibu" value="<?= old('ibupekerjaan'); ?>">
                                <div class="invalid-feedback">
