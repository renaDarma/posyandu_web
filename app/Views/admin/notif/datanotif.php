            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12">
                ...
                <?php if (session()->get('role') == 'admin') : ?>
                  <a href="/tambahnotif" class="btn btn-info">Tambah</a><br><br>
                <?php endif; ?>
                  <div class="x_title">
                    <h2>Tabel Data Imunisasi</h2> 
                    <?php if (session()->get('role') == 'admin') : ?>
                      <div class="col-sm-9">
                        <form action="" method="post">
                          <div class="text-right">
                            <!-- <a href="<?php echo base_url('datanotif/excel') ?>" type="button" class="btn btn-sm btn-outline-success" id="dwn_menu" target="_blank" title="Download Excel"></i> Excel</a>
                            <a href="<?php echo base_url('datanotif/pdf') ?>" type="button" class="btn btn-sm btn-outline-danger" id="dwn_menu" target="_blank" title="Print PDF"></i>PDF</a> -->
                          </div>
                        </form>
                      </div>
                     <?php endif; ?>
                              ...
                              <?php foreach ($notif as $tif) : ?>
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <form action="/hapusnotif/<?= $tif->idnotif; ?>" method="post" class="d-inline">
                                      <?= csrf_field(); ?>
        ...
        function hapusData(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = '/hapusnotif/' + id;
                } else {
    ...
    <script>
        function confirmDelete(event) {
            ...
            Swal.fire({
                ...
                text: 'Apakah Anda yakin menghapus data imunisasi ini?',
                icon: 'warning',
