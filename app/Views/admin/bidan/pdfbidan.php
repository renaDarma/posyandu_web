...
<html  lang="en">
  ...
  <meta charset="UTF-8">
    ...
    <title>Print Daftar Data Bidan</title>
    <style type="text/css">
      body {
        font-family: arial;
      ...
      <div class="isi">
        <div class="data">
          <table width="100%">
                ...
                <tbody>
                  <?php foreach ($bidan as $key => $value):?>
                    <tr>
                      <td><?= $key+1 ?></td>
                      <td><?= $value->bidannama ?></td>
                      <td><?= $value->bidantmptlhr ?></td>
                      <td><?= $value->bidantgllhr ?></td>
                      <td><?= $value->bidanpendidikan ?></td>
                      <td><?= $value->nohp ?></td>
